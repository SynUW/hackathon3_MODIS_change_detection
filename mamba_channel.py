...
class ChangeDetectionMamba(nn.Module):
    ...
    def forward(self, x_2010, x_2015):
        ...
        feats_2010 = self.ffn(feats_2010)
        feats_2015 = self.ffn(feats_2015)

        feats_2010 = self.channel_mamba_blocks(feats_2010).permute(0, 2, 1)
        feats_2015 = self.channel_mamba_blocks(feats_2015).permute(0, 2, 1)
