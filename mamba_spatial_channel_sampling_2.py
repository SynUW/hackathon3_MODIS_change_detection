...
class ChannelWiseAttention(nn.Module):
    def __init__(self, d_model, num_heads=6, sparsity_ratio=0.1, use_sampling=True):
        super().__init__()
