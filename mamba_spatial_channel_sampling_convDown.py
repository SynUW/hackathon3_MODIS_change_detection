...
class ChangeDetectionMamba(nn.Module):
    ...
    def forward(self, x_2010, x_2015):
        ...
        feats_2010 = self.mamba_blocks(feats_2010.permute(0, 2, 1)).permute(0, 2, 1).reshape(B, C, H, W)
        feats_2015 = self.mamba_blocks(feats_2015.permute(0, 2, 1)).permute(0, 2, 1).reshape(B, C, H, W)
