...
class ChangeDetectionMamba(nn.Module):
    def __init__(self, config):
        ...
        self.mamba_blocks_d1 = nn.Sequential(
            *[SparseDeformableMambaBlock(
                dim=config['model']['hidden_dim'],
                d_state=config['model']['d_state'],
                d_conv=config['model']['d_conv'],
        ...
        self.mamba_blocks_d2 = nn.Sequential(
            *[SparseDeformableMambaBlock(
                dim=config['model']['hidden_dim'],
                d_state=config['model']['d_state'],
                d_conv=config['model']['d_conv'],
    ...
    def forward(self, x_2010, x_2015):
        ...
        feats_2010 = self.mamba_blocks_d1(feats_2010)
        feats_2015 = self.mamba_blocks_d1(feats_2015)
