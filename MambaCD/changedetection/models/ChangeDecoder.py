...
class ChangeDecoder(nn.Module):
    def __init__(self, encoder_dims, channel_first, norm_layer, ssm_act_layer, mlp_act_layer, **kwargs):
        ...
        kwargs.setdefault('ssm_dt_rank', "auto")
        kwargs.setdefault('ssm_init', "v0")
        kwargs.setdefault('ssm_forwardtype', "v2")
        kwargs.setdefault('gmlp', False)
        ...
        self.st_block_41 = nn.Sequential(
            ...
            VSSBlock(hidden_dim=128, drop_path=0.1, norm_layer=norm_layer, channel_first=channel_first,
                ...
                forward_type=kwargs.get('ssm_forwardtype', 'v2'), mlp_ratio=kwargs['mlp_ratio'], mlp_act_layer=mlp_act_layer, mlp_drop_rate=kwargs['mlp_drop_rate'],
