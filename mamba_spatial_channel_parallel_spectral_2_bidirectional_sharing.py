...
class ChangeDetectionMamba(nn.Module):
    ...
    def forward(self, x_2010, x_2015):
        ...
        feats_2010_c_out = self.channel_mamba_blocks(feats_2010_c_out.flip(dims=(1,))).flip(dims=(1,))
        feats_2015_c_out = self.channel_mamba_blocks(feats_2015)
        feats_2015_c_out = self.channel_mamba_blocks(feats_2015_c_out.flip(dims=(1,))).flip(dims=(1,))

        feats_2010_s_out = self.spectral_mamba_block(feats_2010_s)
        feats_2010_s_out = self.spectral_mamba_block(feats_2010_s_out.flip(dims=(1,))).flip(dims=(1,))
        feats_2015_s_out = self.spectral_mamba_block(feats_2015_s)
        feats_2015_s_out = self.spectral_mamba_block(feats_2015_s_out.flip(dims=(1,))).flip(dims=(1,))
